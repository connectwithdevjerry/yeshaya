...
import { Search, ChevronLeft, ChevronRight, Ban, Home, Cloud, Volume2 } from 'lucide-react';
import NewKnowledgeBaseModal from '../components/Knowledge/KnowledgeModal';
    ...
    <div className="flex-grow  bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex border-b border-gray-200 mb-6 bg-white rounded-t-lg shadow-sm">
          ...
          <TabButton isActive={activeTab === 'voice'} onClick={() => setActiveTab('voice')}>
            Voice 0
          </TabButton>
          <TabButton isActive={activeTab === 'empty'} onClick={() => setActiveTab('empty')}>
            Empty 0
          </TabButton>
        </div>

        {/* Home Link (as seen in image) */}
      ...
      <NewKnowledgeBaseModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
    </div>
  );
};
