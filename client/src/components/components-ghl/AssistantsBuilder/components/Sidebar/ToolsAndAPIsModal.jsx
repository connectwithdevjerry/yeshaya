    ...
    tools: [
      {
        ...
        description: "Allows the AI to look at a website. You can prompt the website to scrape or use the contact's website in your instructions.",
        icon: Globe,
      },
      {
        title: "Update User Details",
        description: "Updates the contact's information in the CRM. The fields that can be updated using this tool are first name, last name, email, phone number, full address, timezone and website.  ",
        icon: UserRound,
      },
      {
    ...
    tools: [
      {
        ...
        description: "Gets your calendar availability. Always call this tool to get the most up-to-date information about your calendar ID's availability.",
        icon: Calendar,
      },
      {
        title: "Book Appointment",
        description: "Books an appointment with the user. Always get your availability before using this tool to confirm the chosen spot is still available before proceeding to book. Use this tool to book an appointment from an available...",
        icon: Calendar,
      },
      {
        title: "Get User Calendar Events",
        description: "Gets all calendar events schedule with the user and data associated. Use this tool to check the user's current, past and future appointments and get appointment IDs for the events.",
        icon: Calendar,
      }
    ],
  },
...
export const ToolsAndAPIsModal = ({ isOpen, onClose }) => {
  ...
  const filteredData = platformToolsData.filter(
  ...
  return (
    ...
    >
      <div
        className="bg-[#FAFAFA] rounded-2xl shadow-2xl w-full max-w-6xl flex flex-col max-h-[92vh] overflow-hidden"
        ...
        <div className="flex-1 overflow-y-auto px-8 py-4 custom-scrollbar">
          {filteredData.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 text-gray-400">
              ...
              <p className="text-sm">No tools configured for the "{activeTab}" category yet.</p>
            </div>
          )}
        </div>
