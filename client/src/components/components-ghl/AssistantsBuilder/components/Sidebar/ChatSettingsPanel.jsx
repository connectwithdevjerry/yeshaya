...
export const ChatSettingsPanel = () => {
  ...
  useEffect(() => {
    if (selectedAssistant) {
      console.log(
        "📥 Loading assistant data into Chat Settings:",
        selectedAssistant,
      );
      ...
      setSettings({
        ...
        enableMisspellings:
          selectedAssistant.metadata?.enableMisspellings || false,
  ...
  const autoSave = useCallback(
    async (updatedSettings) => {
      ...
      try {
        ...
        const updateData = {
          model: {
            ...selectedAssistant.model, // ✅ Keep ALL existing model fields
            temperature: updatedSettings.temperature,
            maxTokens: updatedSettings.maxTokens,
          },
          metadata: {
            ...selectedAssistant.metadata, // ✅ Keep ALL existing metadata fields
    ...
    <div className="p-4 space-y-5">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500">
              Configure settings for your autopilot mode by setting maximum
              messages a conversation can process, sleep times and more.
            </p>
          </div>
      ...
      <div className="space-y-2 pt-4">
        <div className="flex items-center justify-between">
          ...
          <Info
            className="w-4 h-4 text-gray-400 cursor-pointer"
            title="Select the channels this assistant can respond on."
          />
        </div>
