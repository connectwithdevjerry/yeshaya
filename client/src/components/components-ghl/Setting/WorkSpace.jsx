      ...
      <Card>
        <div className="flex justify-between items-center mb-4 border-b pb-4">
          ...
          <span className="text-sm text-gray-500">
            ID: {company.agencyId ?? (companyLoading ? "Loading..." : "—")}
          </span>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center">
            {companyLoading ? (
              <div className="w-16 h-16 rounded-full flex items-center justify-center bg-gray-100 border border-gray-200">
                Loading...
              </div>
            ) : company.logo ? (
              <img
        ...
        {/* If your API returns separate city/state/postal fields update these accordingly */}
