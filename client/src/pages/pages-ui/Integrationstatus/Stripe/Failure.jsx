...
const TIPS = [
  "Ensure you are logged into the correct Stripe account",
  "Verify that your Stripe account is fully activated (not restricted)",
  "Check that you accepted all Stripe's terms of service",
  "Make sure your browser is not blocking third-party cookies",
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-[250px] h-[250px] rounded-full bg-rose-500/8 blur-3xl" />
      </div>
          ...
          <div className="p-8">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-red-500/10 border border-red-500/20">
                ...
                />
                <span className="text-xs font-semibold text-red-400">Stripe</span>
              </div>
            </motion.div>
